        ...
        stage('Deploy') {
            steps {
               ...
               // sh "scp /var/lib/jenkins/workspace/FirstPipeline/target/helloworld-1.0-SNAPSHOT.jar ec2-user@172.31.21.219:/home/ubuntu/test/"
                ...
                sh "wget --user=admin --password=admin@123 http://ec2-18-202-18-242.eu-west-1.compute.amazonaws.com/nexus/content/repositories/snapshots/com/mycompany/helloworld/1.0-SNAPSHOT/*.jar -O ${WORKSPACE}/*.jar"
                sh "scp ${WORKSPACE}/*.jar ec2-user@172.31.21.219:/home/ec2-user/"
